...
function DeskSetup() {
  return (
    <div>
        ...
        <a
          className='link'
          href='https://www.youtube.com/@yure-ribeiro'
          target="_blank">
          Youtube
        </a>

      <p className='title-link'>Desk Setup:</p>
        <a
          className='link'
        ...
        <a
          ...
          target="_blank">
          Gabinete DARKFLASH DLM 21
        </a>
        <a
          className='link' href='https://www.amazon.com.br/gp/product/B07CZM42VF/ref=ppx_yo_dt_b_asin_image_o00_s00?ie=UTF8&psc=1'
          target="_blank">
          Suporte Monitor F50N
        </a>
        <a
          className='link'
          href='https://shopee.com.br/Mousepad-Gamer-Octopus-80x35-cm-Extra-Grande-i.567190240.19108753661'
          target="_blank">
          MousePad Octopus Gaming 80x35
        </a>
        <a
          className='link'
