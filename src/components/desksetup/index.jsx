...
const SetupItens = () => {
  return (
    <div className={styles.container}>
        <h1 className={styles.title}> meu Setup</h1>
        <a
        ...
        <a
          className={styles.link} href='https://www.amazon.com.br/gp/product/B07CZM42VF/ref=ppx_yo_dt_b_asin_image_o00_s00?ie=UTF8&psc=1'
          target="_blank">
